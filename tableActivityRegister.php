...
//comprobar el inicio de sesion
	...
	$statementTwo= $conexion->prepare('
		SELECT primerApellido, segundoApellido,nombre, matricula, becaActiva FROM  alumnoTutor WHERE tutor_idTutor=:idProfesor');
	/*Ejecutar la sentencia*/
	...
	require 'views/tableActivityRegisterView.php';
		}else{
