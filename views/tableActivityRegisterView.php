<?php require 'headerContentsView.php' ?>
	...
	<main class="seccion registro">
		<h2 class="fw-400 text-center">Registro de actividades</h2>
		<hr>
                	...
                	<thead>
                		...
                		<?php foreach ($resultados as $tutorado): ?>
							...
							<tr>
							  ...
							  <td>
							  	<form action="activityRegister.php" method="POST">

							  		<input class="botonEnlace" name="matriculaPost" type="submit" value="<?php echo $tutorado['matricula']; ?>">
